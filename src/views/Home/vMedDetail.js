...
export default class vMedDetail extends React.Component {
    constructor(props){
        super(props);
            ...
            <View style = {styles.container}>
                ...
                <View style = {styles.formView} >
                    ...
                    <ScrollView style = {{flex : 1, width : '100%',}}>
                        ...
                        {
                            this.state.page != "learn_detail" &&
                            <View style = {{paddingTop : 16, paddingLeft : 8, paddingRight : 8}}>
                                <Text style = {{fontSize : 20, color : constant.Color_Text, marginBottom : 10}}>My Notes</Text>
                                {
                                    [0,1].map((item, index) => 
                                        <View style = {{flexDirection : 'row', justifyContent : 'flex-start', alignItems : 'center', marginTop : 8}}>
                                            <Image source = {icons.circle_check} 
                                                style = {{width : 16, height : 16, resizeMode : 'contain', }}/>
                                            <Text style = {{color : '#919191', fontSize : 14, marginLeft : 12,}}>Dont take at night causes headache.</Text>
                                        </View>
                                    )
                                }
                            </View>
                    ...
                    <View style = {{width : '100%', flexDirection : 'row', justifyContent : 'center', paddingLeft : 4, paddingRight : 4, marginTop : 12, marginBottom : 16}}>
                        <Button
                            icon={ <Feather name="plus" size={22} color="white" /> }
                            title=" Follow"
                            containerStyle = {[styles.loginBtn, {width : '40%', marginRight : 8}]} 
                            titleStyle = {{color : '#fff'}}
                            buttonStyle = {{backgroundColor : '#FA77D7', height : 56}}
                            />
                        <Button title='Save to List' onPress = {this.onLogin} 
                            containerStyle = {[styles.loginBtn, {width : '50%', marginLeft : 8}]} 
