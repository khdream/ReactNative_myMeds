...
export default class vScan1 extends React.Component {
    constructor(props){
        super(props);
    ...
    takePicture = async () => {
        if (this.camera) {
          ...
          this.props.navigation.navigate('scan2')
        }
    };
            ...
            <View style = {styles.container}>
                ...
                <View style={{position : 'absolute', flexDirection : 'row', justifyContent : 'center', bottom : 120, width : '100%'}}>
                    <View style={styles.info}>
                        <Text style = {{fontSize : 11, color : '#fff'}}>1. Scan the front of pill (Name & Dosage)</Text>
                    </View>
                </View>
